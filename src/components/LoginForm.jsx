  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        description: "مرحبًا بك في دفتر الملاحظات الذكي.",
      })
      navigate("/dashboard")
    } catch (error) {
      toast({
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} dir="rtl" {...props}>
            ...
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-muted-foreground text-balance">
                  سجل الدخول إلى حسابك في دفتر الملاحظات الذكي
                </p>
              </div>
              <Field>
      ...
      <FieldDescription className="px-6 text-center">
        بالضغط على المتابعة، أنت توافق على <a href="/terms" className="text-primary hover:underline underline-offset-2">شروط الخدمة</a>{" "}
        و <a href="/privacy" className="text-primary hover:underline underline-offset-2">سياسة الخصوصية</a>.
      </FieldDescription>
    </div>
  )
}
